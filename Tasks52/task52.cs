/* Программа формирует двумерный массив из случайных целых чисели находит среднее арифметическое элементов в каждом столбце.
...
label1: //Оператор "goto" оставил сознательно для сравнения с нижеследующим способом проверки условия (строки 20 - 28)
